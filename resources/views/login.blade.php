        ...
        <li class="no-padding">
          <ul class="collapsible collapsible-accordion">
            ...
            <li class="bold waves-effect active"><a class="collapsible-header">Account<i class="material-icons chevron">chevron_left</i></a>
              <div class="collapsible-body">
                <ul>
                  <li><a href="" class="waves-effect active">Log In<i class="material-icons">person</i></a></li>
        ...
        <div id="friends" class="col s12">
          <ul class="collection flush">
            <li class="collection-item avatar">
              <div class="badged-circle online"><img src="{{asset('img/portrait1.jpg')}}" alt="avatar" class="circle"></div><span class="title">Jane Doe</span>
              <p class="truncate">Lo-fi you probably haven't heard of them</p>
            </li>
            <li class="collection-item avatar">
              <div class="badged-circle"><img src="{{asset('img/portrait2.jpg')}}" alt="avatar" class="circle"></div><span class="title">John Chang</span>
              <p class="truncate">etsy leggings raclette kickstarter four dollar toast</p>
            </li>
            <li class="collection-item avatar">
              <div class="badged-circle"><img src="{{asset('img/portrait3.jpg')}}" alt="avatar" class="circle"></div><span class="title">Lisa Simpson</span>
...
<div class="container" style="padding-top: 200px !important;">
  <div class="row">
    ...
    <div class="col s8 offset-s2">
      <img alt="Materialize" src="https://www.nikken.com/VirtualOfficeNA/assets/images/general/logo-header.png" class="theme-logo" style="position: relative; left: 35%;">
...
<script type="text/javascript" src="{{asset('js/jqvmap/jquery.vmap.world.js')}}" charset="utf-8"></script>
<script type="text/javascript" src="{{asset('js/jqvmap/jquery.vmap.sampledata.js')}}"></script>
